...
export const translations = {
  en: {
    ...
    'partners.villaeira.description': 'Luxury retreat website for a private villa in Kastraki, Naxos.',
    'partners.thecars.description': 'Automotive coverage on all issues and areas.',
    'partners.myplanet.description': 'Landing page for My Planet, a leading Greek sustainable products brand.',
  ...
  gr: {
    ...
    'partners.villaeira.description': 'Ιστοσελίδα πολυτελούς κατοικίας για ιδιωτική βίλα στο Καστράκι της Νάξου.',
    'partners.thecars.description': 'Αυτοκινητιστική κάλυψη σε όλα τα θέματα και τομείς.',
    'partners.myplanet.description': 'Landing page της My Planet που αναδεικνύει τα βιώσιμα προϊόντα και την αποστολή τους.',
