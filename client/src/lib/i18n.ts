...
export const translations = {
  en: {
    ...
    'technology.every-pixel': '**Every pixel counts.**',
  ...
  gr: {
    ...
    'hero.web': 'WEB',
    'hero.architects': 'ARCHITECTS',
    'hero.tagline': 'Ψηφιακές εμπειρίες όπου η ακρίβεια συναντά τη δημιουργικότητα. ',
    ...
    'about.number': '01',
    'about.who': 'ΠΟΙΟΙ',
    'about.we-are': 'ΕΊΜΑΣΤΕ',
    'about.intro': 'Στη <strong>Web Architects</strong>, δημιουργούμε ψηφιακά προϊόντα όπου η αισθητική συναντά την τεχνική καινοτομία.',
    'about.building-purpose': 'Χτίζουμε με Σκοπό',
    'about.description1': 'Βασισμένοι στην αρχή ότι η μορφή και η λειτουργία συμβαδίζουν, αντιμετωπίζουμε κάθε έργο ως μια μοναδική ευκαιρία να λύσουμε πολύπλοκες προκλήσεις με σαφήνεια και καινοτομία.',
    ...
    // Services Section
    'services.number': '02',
    'services.our': 'Η ΔΟΥΛΕΙA',
    'services.work': 'ΜΑΣ',
    'services.description': 'Δημιουργούμε ψηφιακά προϊόντα που συνδυάζουν άρτια λειτουργικότητα με συναισθηματική σύνδεση. Η δουλειά μας συνδυάζει στρατηγική σκέψη και δημιουργικότητα.',
    'services.nav-next': '02 → 03',
    ...
    'services.development.description': 'Δημιουργούμε εφαρμογές έτοιμες για το μέλλον, λύσεις που δεν είναι μόνο γρήγορες και αξιόπιστες σήμερα αλλά και αρκετά ευέλικτες για να εξελιχθούν με την επιχείρησή σας.\n\nΣυνδυάζοντας σύγχρονα frameworks με δοκιμασμένες πρακτικές ανάπτυξης, δημιουργούμε αρχιτεκτονικές που μπορούν να χειριστούν την ανάπτυξη χωρίς να συμβιβάζουν την απόδοση.\n\nΚάθε build ενισχύεται με ισχυρά μέτρα ασφαλείας, βελτιστοποιείται για αποδοτικότητα και σχεδιάζεται να προσαρμόζεται σε νέες τεχνολογίες, διασφαλίζοντας ότι το προϊόν σας παραμένει ανθεκτικό για χρόνια.',
    
    // Technology Section
    'technology.number': '03',
    'technology.our': 'Η',
    'technology.approach': 'ΠΡΟΣΕΓΓΙΣΗ ΜΑΣ',
    'technology.description': 'Τα καλύτερα αποτελέσματα δημιουργούντε στη συνάντηση στρατηγικής σκέψης, δημιουργικού οράματος και τεχνικής ακρίβειας',
    'technology.every-pixel': '<strong>Κάθε pixel μετράει.</strong>',
    'technology.excellence': 'Στοχαστικός σχεδιασμός με τεχνική ακρίβεια',
    ...
    'technology.process2': 'Παραμένουμε εμπλεκόμενοι πέρα από την κυκλοφορία, διασφαλίζοντας ότι η πλατφόρμα σας συνεχίζει να εξελίσσεται, να προσαρμόζεται και να αποδίδει σε ένα μεταβαλλόμενο ψηφιακό τοπίο.',
    'technology.research': 'Έρευνα & Ανακάλυψη',
    ...
    'partners.number': '04',
    'partners.our': 'Η',
    'partners.projects': 'Δουλειά Μας',
    'partners.description': 'Συνεργαζόμαστε με κορυφαίους της βιομηχανίας και καινοτόμες εταιρείες για να παραδώσουμε εξαιρετικά αποτελέσματα. Οι συνεργασίες μας οδηγούν σε αμοιβαία ανάπτυξη και τεχνολογική αριστεία.',
    'partners.nav-next': '04 → 05',
