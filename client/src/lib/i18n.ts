...
export const translations = {
  ...
  gr: {
    ...
    'hero.web': 'WEB',
    'hero.architects': 'ARCHITECTS',
    'hero.tagline': 'Ψηφιακές εμπειρίες όπου η τεχνογνοσία συναντά τη δημιουργικότητα. ',
    ...
    'about.intro': 'Στη <strong>Web Architects</strong>, δημιουργούμε εφαρμογές όπου η αισθητική συναντά την καινοτομία.',
